...
(function () {
  ...
  */
  ...
  function removeDashboardQuickActions(){
    /* Keep Quick Actions visible, but give its buttons their own spacing.
       No dashboard action is removed or disabled. */
    ...
    Array.prototype.forEach.call(headings, function(el){
      ...
      if (section) section.classList.add("quick-actions-section");
    });
  }
